...
description: Modular skill system for analytics engineering, data intelligence, BI, and data science across the full lifecycle — from business question to validated delivery.
---
